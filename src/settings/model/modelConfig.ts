...
import { DEFAULT_OPENROUTER_SETTINGS, OpenRouterConfig } from "./openrouter/openRouterConfig"; // <--- AÑADIDO

export interface ModelConfig extends OpenAIConfig, GoogleConfig, AnthropicConfig, PerplexityConfig, MistralConfig, CohereConfig, OllamaConfig, OpenRouterConfig { // <--- MODIFICADO
    provider: string;
}
...
export const DEFAULT_MODEL_SETTINGS: ModelConfig = {
    ...
    ...DEFAULT_OPENROUTER_SETTINGS, // <--- AÑADIDO
};